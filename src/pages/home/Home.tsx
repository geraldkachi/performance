...
const Home = () => {
  ...
  const { data: overall, isLoading: isLoadingOverall } = useQuery(
    ["overall"],
  ...
  const columns: columnsProps[] | any = [
    ...
    },
    {
      ...
      render: (val: { attendedMeeting: boolean; id: string }) => (
        ...
        >
          {val?.attendedMeeting === true ? "True" : "False"}
        </span>
      ),
      width: "5%",
      align: "center",
    },
    {
      ...
      render: (val: { completedMeeting: boolean; id: string }) => (
        ...
        >
          {val?.completedMeeting === true ? "True" : "False"}
        </span>
      ),
      width: "12%",
      align: "center",
      ...
      responsive: [
        {
          breakpoint: 1000,
          yaxis: {
            categories: overall?.data.map(
              (i: { staffName: string }) => i.staffName
            ),
          },
          options: {
            plotOptions: {
  ...
  return (
    <div>
      ...
      <div className="mt-5 flex items-center justify-between">
        ...
        <Button
          className="cursor-pointer text-center rounded-lg mt-5"
          title="Assign Task"
      ...
      <Modal
        ...
        maskClosable={false}
        closable={true}
        afterClose={() => setStateNewStaff(false)}
      >
