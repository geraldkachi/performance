  ...
  return (
    <div>
      ...
      <div className="mt-5 flex items-center">
        <Button
          variant="primary"
          className="cursor-pointer px-14 py-4 my-5 rounded-lg bg-[#2B8572] text-[#ffffff]"
          type="button"
          title="Start Stand Up"
          onClick={() => navigate(`/stand-up/${"start-standup"}`)}
        />
